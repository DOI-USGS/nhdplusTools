...
#' @title Discover National Hydrography Subsets (Multirealization)
#' @description Subsets NHD features by location (POINT), area (POLYGON),
#' or set of COMIDs. Mutli realizations are supported allowing you to query
...
discover_nhd <- function(AOI = NULL,
