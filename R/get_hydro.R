...
get_huc8 <- function(AOI = NULL, id = NULL){
...
get_huc12 <- function(AOI = NULL, id = NULL){
...
get_waterbodies <- function(AOI = NULL, id = NULL){
...
get_nhdarea <- function(AOI = NULL, id = NULL){
...
get_gagesII <- function(AOI = NULL, id = NULL){
