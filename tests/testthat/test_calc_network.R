...
test_that("total drainage area works", {
  ...
  expect_message(expect_warning(new_da <- calculate_total_drainage_area(catchment_area)))
  ...
  expect_message(expect_warning(expect_warning(calculate_total_drainage_area(catchment_area))))
})
...
test_that("arbolate sum works", {
  ...
  expect_message(expect_warning(arb_sum <- calculate_arbolate_sum(catchment_length)))
