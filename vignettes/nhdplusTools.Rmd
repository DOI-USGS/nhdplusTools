...
Detailed documentation of all the package functions can be found at the **[Reference page](https://usgs-r.github.io/nhdplusTools/reference/)**.
...
1. Indexing data to hydrography: `vignette("point_indexing")`
