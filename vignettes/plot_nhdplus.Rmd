...
basemap_streets <- get_map(maptype = "roadmap", location = ggmap_bbox, zoom = 11)
basemap_satellite <- get_map(maptype = "satellite", location = ggmap_bbox, zoom = 11)
street_map <- ggmap(basemap_streets)
satellite_map <- ggmap(basemap_satellite)

street_map

satellite_map + geom_sf(data = basin,
                        inherit.aes = FALSE,
                        color = "white", fill = NA) + 
