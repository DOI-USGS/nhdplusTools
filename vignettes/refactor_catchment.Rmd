...
First, we need to load up some data to be refactored. For this example, we will use some data available from the nhdplusTools package for testing and examples.

```{r get_data_func, echo=FALSE, message=FALSE} 
# This function doesn't want to work while building vignettes, so hacking it for now.
...
plot(st_geometry(catchment), col = NA, border = "black")
plot(st_geometry(split_cats), col = NA, border = "red")
